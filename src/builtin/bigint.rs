...
impl BigInt {
    ...
    pub fn from_le_bytes(bytes: &[u8]) -> Self {
        ...
        println!("neg={}, bit_count={}, chunks={:?}", false, bit_count, chunks);
    ...
    pub fn bit_at(&self, index: usize) -> Option<u8> {
    ...
    pub fn bit_iter(&self) -> BigIntBitIter {
        BigIntBitIter {
            value: self,
            index: 0,
        }
...
pub struct BigIntBitIter<'a> {
    value: &'a BigInt,
    index: usize,
}

impl<'a> Iterator for BigIntBitIter<'a> {
    type Item = u8;
...
impl<'a> DoubleEndedIterator for BigIntBitIter<'a> {
